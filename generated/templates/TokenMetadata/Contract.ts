...
export class Contract extends ethereum.SmartContract {
  ...
  getBalance(_ownerOf: Address): BigInt {
    let result = super.call("getBalance", "getBalance(address):(uint256)", [
      ethereum.Value.fromAddress(_ownerOf),
    ]);

    return result[0].toBigInt();
  }

  try_getBalance(_ownerOf: Address): ethereum.CallResult<BigInt> {
  ...
  walletMints(param0: Address): BigInt {
    let result = super.call("walletMints", "walletMints(address):(uint256)", [
  ...
  try_walletMints(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "walletMints",
